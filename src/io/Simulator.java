...
/**
 * Simulator.java - simulates inputs and outputs to standards like the java.lang
 * class and redirects those outputs to customs
 *
 * @author Mr. Wachs
 * @since June 2023
 */
public class Simulator {
    ...
    public static void output(Object object, boolean newLine) {
        ...
        if (newLine) {
            simpleOutput(text + NEW_LINE, text);
        } else {
            simpleOutput(text, text);
        }
    }

    /**
     * Adds this object to the dynamic list of outputs with a new line
     *
     * @param obj the object (as a string) to add to output
     */
